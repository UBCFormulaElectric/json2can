...
class JsonCanParser:
    ...
    def _get_parsed_can_message(self, msg_name: str, msg_json_data: Dict, node: str) -> CanMessage:
        ...
        return CanMessage(
            ...
            tx_node=node,
            rx_nodes=[self._bus_cfg.default_receiver] # Every msg is received by the default receiver
        )
    ...
    def _get_parsed_can_signal(self, signal_name: str, signal_json_data: Dict, next_available_bit: int) -> CanSignal:
        ...
        start_val, _ = self._get_optional_value(signal_json_data, "start_value", self._bus_cfg.start_value_default)
