...
TODO: Better sorting of messages/signals in the DBC
'''
...
class DbcGenerator(FileGenerator):
    '''
    Class for generating a DBC file from a CanDatabase object.
    '''
    def __init__(self, output_dir: str, database: CanDatabase):
        super().__init__(output_path=output_dir)
        self._db = database

    def generate_dbc(self) -> None:
        '''
