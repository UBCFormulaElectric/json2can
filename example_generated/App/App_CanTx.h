 ...
 */
JCT_Alert App_CanTx_JCT_AlertSet_JCT_AlertSet_Get(void);

/**
 * Return value from TX table of signal JCT_AlertCleared in msg JCT_AlertCleared.
 */
JCT_Alert App_CanTx_JCT_AlertCleared_JCT_AlertCleared_Get(void);
 ...
 */
const JCT_AlertSet_Signals* App_CanTx_JCT_AlertSet_GetData(void);

/**
 * Returns pointer to the struct of msg JCT_AlertCleared signals in the TX table.
 */
const JCT_AlertCleared_Signals* App_CanTx_JCT_AlertCleared_GetData(void);
