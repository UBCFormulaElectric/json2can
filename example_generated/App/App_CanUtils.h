...
/**
 * Signals in CAN message JSONCANTest_VITALS, transmitted by the JSONCANTest.
 */
typedef struct
{
    /*
...
/**
 * Signals in CAN message JSONCANTest_NON_CRITICAL_ERRORS, transmitted by the JSONCANTest.
 */
typedef struct
{
    /*
...
/**
 * Signals in CAN message JSONCANTest_AIR_SHUTDOWN_ERRORS, transmitted by the JSONCANTest.
 */
typedef struct
{
    /*
...
/**
 * Signals in CAN message JSONCANTest_MOTOR_SHUTDOWN_ERRORS, transmitted by the JSONCANTest.
 */
typedef struct
{
    /*
...
/**
 * Signals in CAN message JSONCANTest_STATUS, transmitted by the JSONCANTest.
 */
typedef struct
{
    /*
...
/**
 * Signals in CAN message FSM_APPS, received by the JSONCANTest.
 */
typedef struct
{
    /*
...
/**
 * Signals in CAN message FSM_NON_CRITICAL_ERRORS, received by the JSONCANTest.
 */
typedef struct
{
    /*
...
/**
 * @brief Check if the signal TIMESTAMP in message JSONCANTest_VITALS is within its valid range.
 */ 
bool App_CanMsgs_JSONCANTest_VITALS_TIMESTAMP_Clamp(uint32_t value);

/**
 * @brief Check if the signal CONTACTORS_CLOSED in message JSONCANTest_STATUS is within its valid range.
 */ 
bool App_CanMsgs_JSONCANTest_STATUS_CONTACTORS_CLOSED_Clamp(AIR_STATE value);

/**
 * @brief Check if the signal CURRENT in message JSONCANTest_STATUS is within its valid range.
 */ 
bool App_CanMsgs_JSONCANTest_STATUS_CURRENT_Clamp(float value);

/**
 * @brief Check if the signal VOLTAGE in message JSONCANTest_STATUS is within its valid range.
 */ 
bool App_CanMsgs_JSONCANTest_STATUS_VOLTAGE_Clamp(float value);

/**
 * @brief Check if the signal Papps_Mapped_Pedal_Percentage in message FSM_APPS is within its valid range.
 */ 
bool App_CanMsgs_FSM_APPS_Papps_Mapped_Pedal_Percentage_Clamp(float value);

/**
 * @brief Check if the signal Sapps_Mapped_Pedal_Percentage in message FSM_APPS is within its valid range.
 */ 
bool App_CanMsgs_FSM_APPS_Sapps_Mapped_Pedal_Percentage_Clamp(float value);

/**
 * @brief Check if the signal LEFT_WHEEL_SPEED_OUT_OF_RANGE in message FSM_NON_CRITICAL_ERRORS is within its valid range.
 */ 
bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_Clamp(uint32_t value);

/**
 * @brief Check if the signal RIGHT_WHEEL_SPEED_OUT_OF_RANGE in message FSM_NON_CRITICAL_ERRORS is within its valid range.
 */ 
bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_Clamp(uint32_t value);

/**
 * @brief Check if the signal FLOW_RATE_OUT_OF_RANGE in message FSM_NON_CRITICAL_ERRORS is within its valid range.
 */ 
bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_Clamp(uint32_t value);

/**
 * @brief Check if the signal STEERING_ANGLE_OUT_OF_RANGE in message FSM_NON_CRITICAL_ERRORS is within its valid range.
 */ 
bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_Clamp(uint32_t value);

/**
 * @brief Check if the signal BRAKE_PRESSURE_OUT_OF_RANGE in message FSM_NON_CRITICAL_ERRORS is within its valid range.
 */ 
