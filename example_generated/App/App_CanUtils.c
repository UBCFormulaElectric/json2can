 ...
 * @brief Encode signal value to get CAN payload represenation.
 */ 
int Encode_Int(int input, int scale, int offset) 
{
 ...
 * @brief Decode payload bits to get signal value.
 */ 
int Decode_Int(int input, int scale, int offset) 
{
...
void App_CanMsgs_JSONCANTest_VITALS_Pack(const JSONCANTest_VITALS_Signals* const in_msg, uint8_t* const out_data) 
{
    ...
    const uint32_t HEARTBEAT_raw = Encode_Uint(HEARTBEAT_val, CANSIG_JSONCANTest_VITALS_HEARTBEAT_SCALE, CANSIG_JSONCANTest_VITALS_HEARTBEAT_OFFSET);
    ...
    const uint32_t TIMESTAMP_raw = Encode_Uint(TIMESTAMP_val, CANSIG_JSONCANTest_VITALS_TIMESTAMP_SCALE, CANSIG_JSONCANTest_VITALS_TIMESTAMP_OFFSET);
...
void App_CanMsgs_JSONCANTest_NON_CRITICAL_ERRORS_Pack(const JSONCANTest_NON_CRITICAL_ERRORS_Signals* const in_msg, uint8_t* const out_data) 
{
    ...
    const bool WATCHDOG_TIMEOUT_val = in_msg->WATCHDOG_TIMEOUT_value;
    const uint32_t WATCHDOG_TIMEOUT_raw = Encode_Uint(WATCHDOG_TIMEOUT_val, CANSIG_JSONCANTest_NON_CRITICAL_ERRORS_WATCHDOG_TIMEOUT_SCALE, CANSIG_JSONCANTest_NON_CRITICAL_ERRORS_WATCHDOG_TIMEOUT_OFFSET);
    ...
    const bool BOARD_OVERTEMP_val = in_msg->BOARD_OVERTEMP_value;
    const uint32_t BOARD_OVERTEMP_raw = Encode_Uint(BOARD_OVERTEMP_val, CANSIG_JSONCANTest_NON_CRITICAL_ERRORS_BOARD_OVERTEMP_SCALE, CANSIG_JSONCANTest_NON_CRITICAL_ERRORS_BOARD_OVERTEMP_OFFSET);
    ...
    const bool BOARD_OVERVOLTAGE_val = in_msg->BOARD_OVERVOLTAGE_value;
    const uint32_t BOARD_OVERVOLTAGE_raw = Encode_Uint(BOARD_OVERVOLTAGE_val, CANSIG_JSONCANTest_NON_CRITICAL_ERRORS_BOARD_OVERVOLTAGE_SCALE, CANSIG_JSONCANTest_NON_CRITICAL_ERRORS_BOARD_OVERVOLTAGE_OFFSET);
...
void App_CanMsgs_JSONCANTest_AIR_SHUTDOWN_ERRORS_Pack(const JSONCANTest_AIR_SHUTDOWN_ERRORS_Signals* const in_msg, uint8_t* const out_data) 
{
    ...
    const bool DUMMY_AIR_SHUTDOWN_val = in_msg->DUMMY_AIR_SHUTDOWN_value;
    const uint32_t DUMMY_AIR_SHUTDOWN_raw = Encode_Uint(DUMMY_AIR_SHUTDOWN_val, CANSIG_JSONCANTest_AIR_SHUTDOWN_ERRORS_DUMMY_AIR_SHUTDOWN_SCALE, CANSIG_JSONCANTest_AIR_SHUTDOWN_ERRORS_DUMMY_AIR_SHUTDOWN_OFFSET);
...
void App_CanMsgs_JSONCANTest_MOTOR_SHUTDOWN_ERRORS_Pack(const JSONCANTest_MOTOR_SHUTDOWN_ERRORS_Signals* const in_msg, uint8_t* const out_data) 
{
    ...
    const bool DUMMY_MOTOR_SHUTDOWN_val = in_msg->DUMMY_MOTOR_SHUTDOWN_value;
    const uint32_t DUMMY_MOTOR_SHUTDOWN_raw = Encode_Uint(DUMMY_MOTOR_SHUTDOWN_val, CANSIG_JSONCANTest_MOTOR_SHUTDOWN_ERRORS_DUMMY_MOTOR_SHUTDOWN_SCALE, CANSIG_JSONCANTest_MOTOR_SHUTDOWN_ERRORS_DUMMY_MOTOR_SHUTDOWN_OFFSET);
...
void App_CanMsgs_JSONCANTest_STATUS_Pack(const JSONCANTest_STATUS_Signals* const in_msg, uint8_t* const out_data) 
{
    ...
    const AIR_STATE CONTACTORS_CLOSED_val = in_msg->CONTACTORS_CLOSED_value;
    const uint32_t CONTACTORS_CLOSED_raw = Encode_Uint(CONTACTORS_CLOSED_val, CANSIG_JSONCANTest_STATUS_CONTACTORS_CLOSED_SCALE, CANSIG_JSONCANTest_STATUS_CONTACTORS_CLOSED_OFFSET);
    ...
    const uint32_t CURRENT_raw = Encode_Float(CURRENT_val, CANSIG_JSONCANTest_STATUS_CURRENT_SCALE, CANSIG_JSONCANTest_STATUS_CURRENT_OFFSET);
    ...
    const uint32_t VOLTAGE_raw = Encode_Float(VOLTAGE_val, CANSIG_JSONCANTest_STATUS_VOLTAGE_SCALE, CANSIG_JSONCANTest_STATUS_VOLTAGE_OFFSET);
...
void App_CanMsgs_FSM_APPS_Unpack(const uint8_t* const in_data, FSM_APPS_Signals* const out_msg) 
{
    ...
    const float Papps_Mapped_Pedal_Percentage_val = Decode_Float(Papps_Mapped_Pedal_Percentage_raw, CANSIG_FSM_APPS_Papps_Mapped_Pedal_Percentage_SCALE, CANSIG_FSM_APPS_Papps_Mapped_Pedal_Percentage_OFFSET);
    out_msg->Papps_Mapped_Pedal_Percentage_value = Papps_Mapped_Pedal_Percentage_val;
    ...
    const float Sapps_Mapped_Pedal_Percentage_val = Decode_Float(Sapps_Mapped_Pedal_Percentage_raw, CANSIG_FSM_APPS_Sapps_Mapped_Pedal_Percentage_SCALE, CANSIG_FSM_APPS_Sapps_Mapped_Pedal_Percentage_OFFSET);
    out_msg->Sapps_Mapped_Pedal_Percentage_value = Sapps_Mapped_Pedal_Percentage_val;
}
...
void App_CanMsgs_FSM_NON_CRITICAL_ERRORS_Unpack(const uint8_t* const in_data, FSM_NON_CRITICAL_ERRORS_Signals* const out_msg) 
{
    ...
    const bool papps_out_of_range_val = Decode_Uint(papps_out_of_range_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_papps_out_of_range_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_papps_out_of_range_OFFSET);
    out_msg->papps_out_of_range_value = papps_out_of_range_val;
    ...
    const bool sapps_out_of_range_val = Decode_Uint(sapps_out_of_range_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_sapps_out_of_range_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_sapps_out_of_range_OFFSET);
    out_msg->sapps_out_of_range_value = sapps_out_of_range_val;
    ...
    const bool STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ_val = Decode_Uint(STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ_OFFSET);
    out_msg->STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ_value = STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ_val;
    ...
    const bool STACK_WATERMARK_ABOVE_THRESHOLD_TASK1KHZ_val = Decode_Uint(STACK_WATERMARK_ABOVE_THRESHOLD_TASK1KHZ_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1KHZ_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1KHZ_OFFSET);
    out_msg->STACK_WATERMARK_ABOVE_THRESHOLD_TASK1KHZ_value = STACK_WATERMARK_ABOVE_THRESHOLD_TASK1KHZ_val;
    ...
    const bool STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANRX_val = Decode_Uint(STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANRX_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANRX_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANRX_OFFSET);
    out_msg->STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANRX_value = STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANRX_val;
    ...
    const bool STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANTX_val = Decode_Uint(STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANTX_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANTX_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANTX_OFFSET);
    out_msg->STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANTX_value = STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANTX_val;
    ...
    const bool WATCHDOG_TIMEOUT_val = Decode_Uint(WATCHDOG_TIMEOUT_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_WATCHDOG_TIMEOUT_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_WATCHDOG_TIMEOUT_OFFSET);
    out_msg->WATCHDOG_TIMEOUT_value = WATCHDOG_TIMEOUT_val;
    ...
    const bool BSPD_FAULT_val = Decode_Uint(BSPD_FAULT_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_BSPD_FAULT_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_BSPD_FAULT_OFFSET);
    out_msg->BSPD_FAULT_value = BSPD_FAULT_val;
    ...
    const uint32_t LEFT_WHEEL_SPEED_OUT_OF_RANGE_val = Decode_Uint(LEFT_WHEEL_SPEED_OUT_OF_RANGE_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_OFFSET);
    out_msg->LEFT_WHEEL_SPEED_OUT_OF_RANGE_value = LEFT_WHEEL_SPEED_OUT_OF_RANGE_val;
    ...
    const uint32_t RIGHT_WHEEL_SPEED_OUT_OF_RANGE_val = Decode_Uint(RIGHT_WHEEL_SPEED_OUT_OF_RANGE_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_OFFSET);
    out_msg->RIGHT_WHEEL_SPEED_OUT_OF_RANGE_value = RIGHT_WHEEL_SPEED_OUT_OF_RANGE_val;
    ...
    const uint32_t FLOW_RATE_OUT_OF_RANGE_val = Decode_Uint(FLOW_RATE_OUT_OF_RANGE_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_OFFSET);
    out_msg->FLOW_RATE_OUT_OF_RANGE_value = FLOW_RATE_OUT_OF_RANGE_val;
    ...
    const uint32_t STEERING_ANGLE_OUT_OF_RANGE_val = Decode_Uint(STEERING_ANGLE_OUT_OF_RANGE_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_OFFSET);
    out_msg->STEERING_ANGLE_OUT_OF_RANGE_value = STEERING_ANGLE_OUT_OF_RANGE_val;
    ...
    const uint32_t BRAKE_PRESSURE_OUT_OF_RANGE_val = Decode_Uint(BRAKE_PRESSURE_OUT_OF_RANGE_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OUT_OF_RANGE_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OUT_OF_RANGE_OFFSET);
    out_msg->BRAKE_PRESSURE_OUT_OF_RANGE_value = BRAKE_PRESSURE_OUT_OF_RANGE_val;
    ...
    const bool BRAKE_PRESSURE_OPEN_SC_val = Decode_Uint(BRAKE_PRESSURE_OPEN_SC_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OPEN_SC_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OPEN_SC_OFFSET);
    out_msg->BRAKE_PRESSURE_OPEN_SC_value = BRAKE_PRESSURE_OPEN_SC_val;
    ...
    const bool BRAKE_PRESSURE_OPEN_OC_val = Decode_Uint(BRAKE_PRESSURE_OPEN_OC_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OPEN_OC_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OPEN_OC_OFFSET);
    out_msg->BRAKE_PRESSURE_OPEN_OC_value = BRAKE_PRESSURE_OPEN_OC_val;
    ...
    const bool STEERING_WHEEL_BROKE_val = Decode_Uint(STEERING_WHEEL_BROKE_raw, CANSIG_FSM_NON_CRITICAL_ERRORS_STEERING_WHEEL_BROKE_SCALE, CANSIG_FSM_NON_CRITICAL_ERRORS_STEERING_WHEEL_BROKE_OFFSET);
    out_msg->STEERING_WHEEL_BROKE_value = STEERING_WHEEL_BROKE_val;
}

bool App_CanMsgs_JSONCANTest_VITALS_TIMESTAMP_Clamp(uint32_t value) 
{
    return value;
}

bool App_CanMsgs_JSONCANTest_STATUS_CONTACTORS_CLOSED_Clamp(AIR_STATE value) 
{
    return value > CANSIG_JSONCANTest_STATUS_CONTACTORS_CLOSED_MAX ? CANSIG_JSONCANTest_STATUS_CONTACTORS_CLOSED_MAX : value;
}

bool App_CanMsgs_JSONCANTest_STATUS_CURRENT_Clamp(float value) 
{
    const float clamped = value < CANSIG_JSONCANTest_STATUS_CURRENT_MIN ? CANSIG_JSONCANTest_STATUS_CURRENT_MIN : value;
    return clamped > CANSIG_JSONCANTest_STATUS_CURRENT_MAX ? CANSIG_JSONCANTest_STATUS_CURRENT_MAX : clamped;
}

bool App_CanMsgs_JSONCANTest_STATUS_VOLTAGE_Clamp(float value) 
{
    const float clamped = value < CANSIG_JSONCANTest_STATUS_VOLTAGE_MIN ? CANSIG_JSONCANTest_STATUS_VOLTAGE_MIN : value;
    return clamped > CANSIG_JSONCANTest_STATUS_VOLTAGE_MAX ? CANSIG_JSONCANTest_STATUS_VOLTAGE_MAX : clamped;
}

bool App_CanMsgs_FSM_APPS_Papps_Mapped_Pedal_Percentage_Clamp(float value) 
{
    const float clamped = value < CANSIG_FSM_APPS_Papps_Mapped_Pedal_Percentage_MIN ? CANSIG_FSM_APPS_Papps_Mapped_Pedal_Percentage_MIN : value;
    return clamped > CANSIG_FSM_APPS_Papps_Mapped_Pedal_Percentage_MAX ? CANSIG_FSM_APPS_Papps_Mapped_Pedal_Percentage_MAX : clamped;
}

bool App_CanMsgs_FSM_APPS_Sapps_Mapped_Pedal_Percentage_Clamp(float value) 
{
    const float clamped = value < CANSIG_FSM_APPS_Sapps_Mapped_Pedal_Percentage_MIN ? CANSIG_FSM_APPS_Sapps_Mapped_Pedal_Percentage_MIN : value;
    return clamped > CANSIG_FSM_APPS_Sapps_Mapped_Pedal_Percentage_MAX ? CANSIG_FSM_APPS_Sapps_Mapped_Pedal_Percentage_MAX : clamped;
}

bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_Clamp(uint32_t value) 
{
    return value > CANSIG_FSM_NON_CRITICAL_ERRORS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_MAX ? CANSIG_FSM_NON_CRITICAL_ERRORS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_MAX : value;
}

bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_Clamp(uint32_t value) 
{
    return value > CANSIG_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_MAX ? CANSIG_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_MAX : value;
}

bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_Clamp(uint32_t value) 
{
    return value > CANSIG_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_MAX ? CANSIG_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_MAX : value;
}

bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_Clamp(uint32_t value) 
{
    return value > CANSIG_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_MAX ? CANSIG_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_MAX : value;
}

bool App_CanMsgs_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OUT_OF_RANGE_Clamp(uint32_t value) 
{
    return value > CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OUT_OF_RANGE_MAX ? CANSIG_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OUT_OF_RANGE_MAX : value;
}
