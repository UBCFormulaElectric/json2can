...
void App_CanUtils_FsmApps_Unpack(const uint8_t* const in_data, FsmApps_Signals* const out_msg)
{
    ...
    const float PappsMappedPedalPercentage_val = CAN_DECODE(PappsMappedPedalPercentage_raw, CANSIG_FSM_APPS_PAPPS_MAPPED_PEDAL_PERCENTAGE_SCALE, CANSIG_FSM_APPS_PAPPS_MAPPED_PEDAL_PERCENTAGE_OFFSET, float);
    ...
    const float SappsMappedPedalPercentage_val = CAN_DECODE(SappsMappedPedalPercentage_raw, CANSIG_FSM_APPS_SAPPS_MAPPED_PEDAL_PERCENTAGE_SCALE, CANSIG_FSM_APPS_SAPPS_MAPPED_PEDAL_PERCENTAGE_OFFSET, float);
...
void App_CanUtils_FsmWarnings_Unpack(const uint8_t* const in_data, FsmWarnings_Signals* const out_msg)
{
    ...
    const bool PappsOutOfRange_val = CAN_DECODE(PappsOutOfRange_raw, CANSIG_FSM_WARNINGS_PAPPS_OUT_OF_RANGE_SCALE, CANSIG_FSM_WARNINGS_PAPPS_OUT_OF_RANGE_OFFSET, uint32_t);
    ...
    const bool SappsOutOfRange_val = CAN_DECODE(SappsOutOfRange_raw, CANSIG_FSM_WARNINGS_SAPPS_OUT_OF_RANGE_SCALE, CANSIG_FSM_WARNINGS_SAPPS_OUT_OF_RANGE_OFFSET, uint32_t);
    ...
    const bool StackWatermarkAboveThresholdTask1Hz_val = CAN_DECODE(StackWatermarkAboveThresholdTask1Hz_raw, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1_HZ_SCALE, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1_HZ_OFFSET, uint32_t);
    ...
    const bool StackWatermarkAboveThresholdTask1kHz_val = CAN_DECODE(StackWatermarkAboveThresholdTask1kHz_raw, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1K_HZ_SCALE, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1K_HZ_OFFSET, uint32_t);
    ...
    const bool StackWatermarkAboveThresholdTaskCanRx_val = CAN_DECODE(StackWatermarkAboveThresholdTaskCanRx_raw, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK_CAN_RX_SCALE, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK_CAN_RX_OFFSET, uint32_t);
    ...
    const bool StackWatermarkAboveThresholdTaskCanTx_val = CAN_DECODE(StackWatermarkAboveThresholdTaskCanTx_raw, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK_CAN_TX_SCALE, CANSIG_FSM_WARNINGS_STACK_WATERMARK_ABOVE_THRESHOLD_TASK_CAN_TX_OFFSET, uint32_t);
    ...
    const bool WatchdogFault_val = CAN_DECODE(WatchdogFault_raw, CANSIG_FSM_WARNINGS_WATCHDOG_FAULT_SCALE, CANSIG_FSM_WARNINGS_WATCHDOG_FAULT_OFFSET, uint32_t);
    ...
    const bool BspdFault_val = CAN_DECODE(BspdFault_raw, CANSIG_FSM_WARNINGS_BSPD_FAULT_SCALE, CANSIG_FSM_WARNINGS_BSPD_FAULT_OFFSET, uint32_t);
    ...
    const uint32_t LeftWheelSpeedOutOfRange_val = CAN_DECODE(LeftWheelSpeedOutOfRange_raw, CANSIG_FSM_WARNINGS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_SCALE, CANSIG_FSM_WARNINGS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_OFFSET, uint32_t);
    ...
    const uint32_t RightWheelSpeedOutOfRange_val = CAN_DECODE(RightWheelSpeedOutOfRange_raw, CANSIG_FSM_WARNINGS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_SCALE, CANSIG_FSM_WARNINGS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_OFFSET, uint32_t);
    ...
    const uint32_t FlowRateOutOfRange_val = CAN_DECODE(FlowRateOutOfRange_raw, CANSIG_FSM_WARNINGS_FLOW_RATE_OUT_OF_RANGE_SCALE, CANSIG_FSM_WARNINGS_FLOW_RATE_OUT_OF_RANGE_OFFSET, uint32_t);
    ...
    const uint32_t SteeringAngleOutOfRange_val = CAN_DECODE(SteeringAngleOutOfRange_raw, CANSIG_FSM_WARNINGS_STEERING_ANGLE_OUT_OF_RANGE_SCALE, CANSIG_FSM_WARNINGS_STEERING_ANGLE_OUT_OF_RANGE_OFFSET, uint32_t);
    ...
    const uint32_t BrakePressureOutOfRange_val = CAN_DECODE(BrakePressureOutOfRange_raw, CANSIG_FSM_WARNINGS_BRAKE_PRESSURE_OUT_OF_RANGE_SCALE, CANSIG_FSM_WARNINGS_BRAKE_PRESSURE_OUT_OF_RANGE_OFFSET, uint32_t);
    ...
    const bool BrakePressureSc_val = CAN_DECODE(BrakePressureSc_raw, CANSIG_FSM_WARNINGS_BRAKE_PRESSURE_SC_SCALE, CANSIG_FSM_WARNINGS_BRAKE_PRESSURE_SC_OFFSET, uint32_t);
    ...
    const bool BrakePressureOc_val = CAN_DECODE(BrakePressureOc_raw, CANSIG_FSM_WARNINGS_BRAKE_PRESSURE_OC_SCALE, CANSIG_FSM_WARNINGS_BRAKE_PRESSURE_OC_OFFSET, uint32_t);
    ...
    const bool SteeringWheelBroke_val = CAN_DECODE(SteeringWheelBroke_raw, CANSIG_FSM_WARNINGS_STEERING_WHEEL_BROKE_SCALE, CANSIG_FSM_WARNINGS_STEERING_WHEEL_BROKE_OFFSET, uint32_t);
