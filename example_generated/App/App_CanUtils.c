...
void App_CanUtils_JCT_noncriticalErrors_Pack(const JCT_noncriticalErrors_Signals* const in_msg, uint8_t* const out_data)
{
    ...
    const uint32_t watchdogTimeout_raw = CAN_ENCODE(watchdogTimeout_val, CANSIG_JCT_noncriticalErrors_watchdogTimeout_SCALE, CANSIG_JCT_noncriticalErrors_watchdogTimeout_OFFSET, uint32_t);
    ...
    const uint32_t boardOvertemp_raw = CAN_ENCODE(boardOvertemp_val, CANSIG_JCT_noncriticalErrors_boardOvertemp_SCALE, CANSIG_JCT_noncriticalErrors_boardOvertemp_OFFSET, uint32_t);
    ...
    const uint32_t boardOvervoltage_raw = CAN_ENCODE(boardOvervoltage_val, CANSIG_JCT_noncriticalErrors_boardOvervoltage_SCALE, CANSIG_JCT_noncriticalErrors_boardOvervoltage_OFFSET, uint32_t);
...
void App_CanUtils_JCT_AIRShutdownErrors_Pack(const JCT_AIRShutdownErrors_Signals* const in_msg, uint8_t* const out_data)
{
    ...
    const uint32_t dummyAirShutdown_raw = CAN_ENCODE(dummyAirShutdown_val, CANSIG_JCT_AIRShutdownErrors_dummyAirShutdown_SCALE, CANSIG_JCT_AIRShutdownErrors_dummyAirShutdown_OFFSET, uint32_t);
...
void App_CanUtils_JCT_motorShutdownErrors_Pack(const JCT_motorShutdownErrors_Signals* const in_msg, uint8_t* const out_data)
{
    ...
    const uint32_t dummyMotorShutdown_raw = CAN_ENCODE(dummyMotorShutdown_val, CANSIG_JCT_motorShutdownErrors_dummyMotorShutdown_SCALE, CANSIG_JCT_motorShutdownErrors_dummyMotorShutdown_OFFSET, uint32_t);
...
void App_CanUtils_JCT_status_Pack(const JCT_status_Signals* const in_msg, uint8_t* const out_data)
{
    ...
    const uint32_t contactorsClosed_raw = CAN_ENCODE(contactorsClosed_val, CANSIG_JCT_status_contactorsClosed_SCALE, CANSIG_JCT_status_contactorsClosed_OFFSET, uint32_t);
    ...
    const uint32_t unsigned_tester_raw = CAN_ENCODE(unsigned_tester_val, CANSIG_JCT_status_unsigned_tester_SCALE, CANSIG_JCT_status_unsigned_tester_OFFSET, int);
...
void App_CanUtils_JCT_AlertSet_Pack(const JCT_AlertSet_Signals* const in_msg, uint8_t* const out_data)
{
    ...
    const uint32_t JCT_AlertSet_raw = CAN_ENCODE(JCT_AlertSet_val, CANSIG_JCT_AlertSet_JCT_AlertSet_SCALE, CANSIG_JCT_AlertSet_JCT_AlertSet_OFFSET, uint32_t);
...
void App_CanUtils_JCT_AlertCleared_Pack(const JCT_AlertCleared_Signals* const in_msg, uint8_t* const out_data)
{
    ...
    const uint32_t JCT_AlertCleared_raw = CAN_ENCODE(JCT_AlertCleared_val, CANSIG_JCT_AlertCleared_JCT_AlertCleared_SCALE, CANSIG_JCT_AlertCleared_JCT_AlertCleared_OFFSET, uint32_t);
...
void App_CanUtils_FSM_apps_Unpack(const uint8_t* const in_data, FSM_apps_Signals* const out_msg)
{
    ...
    const float pappsMappedPedalPercentage_val = CAN_DECODE(pappsMappedPedalPercentage_raw, CANSIG_FSM_apps_pappsMappedPedalPercentage_SCALE, CANSIG_FSM_apps_pappsMappedPedalPercentage_OFFSET, float);
    ...
    const float sappsMappedPedalPercentage_val = CAN_DECODE(sappsMappedPedalPercentage_raw, CANSIG_FSM_apps_sappsMappedPedalPercentage_SCALE, CANSIG_FSM_apps_sappsMappedPedalPercentage_OFFSET, float);
...
void App_CanUtils_FSM_noncriticalErrors_Unpack(const uint8_t* const in_data, FSM_noncriticalErrors_Signals* const out_msg)
{
    ...
    const bool pappsOutOfRange_val = CAN_DECODE(pappsOutOfRange_raw, CANSIG_FSM_noncriticalErrors_pappsOutOfRange_SCALE, CANSIG_FSM_noncriticalErrors_pappsOutOfRange_OFFSET, uint32_t);
    ...
    const bool sappsOutOfRange_val = CAN_DECODE(sappsOutOfRange_raw, CANSIG_FSM_noncriticalErrors_sappsOutOfRange_SCALE, CANSIG_FSM_noncriticalErrors_sappsOutOfRange_OFFSET, uint32_t);
    ...
    const bool stackWatermarkAboveThresholdTask1Hz_val = CAN_DECODE(stackWatermarkAboveThresholdTask1Hz_raw, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTask1Hz_SCALE, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTask1Hz_OFFSET, uint32_t);
    ...
    const bool stackWatermarkAboveThresholdTask1kHz_val = CAN_DECODE(stackWatermarkAboveThresholdTask1kHz_raw, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTask1kHz_SCALE, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTask1kHz_OFFSET, uint32_t);
    ...
    const bool stackWatermarkAboveThresholdTaskCanRx_val = CAN_DECODE(stackWatermarkAboveThresholdTaskCanRx_raw, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTaskCanRx_SCALE, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTaskCanRx_OFFSET, uint32_t);
    ...
    const bool stackWatermarkAboveThresholdTaskCanTx_val = CAN_DECODE(stackWatermarkAboveThresholdTaskCanTx_raw, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTaskCanTx_SCALE, CANSIG_FSM_noncriticalErrors_stackWatermarkAboveThresholdTaskCanTx_OFFSET, uint32_t);
    ...
    const bool watchdogFault_val = CAN_DECODE(watchdogFault_raw, CANSIG_FSM_noncriticalErrors_watchdogFault_SCALE, CANSIG_FSM_noncriticalErrors_watchdogFault_OFFSET, uint32_t);
    ...
    const bool bspdFault_val = CAN_DECODE(bspdFault_raw, CANSIG_FSM_noncriticalErrors_bspdFault_SCALE, CANSIG_FSM_noncriticalErrors_bspdFault_OFFSET, uint32_t);
    ...
    const uint32_t leftWheelSpeedOutOfRange_val = CAN_DECODE(leftWheelSpeedOutOfRange_raw, CANSIG_FSM_noncriticalErrors_leftWheelSpeedOutOfRange_SCALE, CANSIG_FSM_noncriticalErrors_leftWheelSpeedOutOfRange_OFFSET, uint32_t);
    ...
    const uint32_t rightWheelSpeedOutOfRange_val = CAN_DECODE(rightWheelSpeedOutOfRange_raw, CANSIG_FSM_noncriticalErrors_rightWheelSpeedOutOfRange_SCALE, CANSIG_FSM_noncriticalErrors_rightWheelSpeedOutOfRange_OFFSET, uint32_t);
    ...
    const uint32_t flowRateOutOfRange_val = CAN_DECODE(flowRateOutOfRange_raw, CANSIG_FSM_noncriticalErrors_flowRateOutOfRange_SCALE, CANSIG_FSM_noncriticalErrors_flowRateOutOfRange_OFFSET, uint32_t);
    ...
    const uint32_t steeringAngleOutOfRange_val = CAN_DECODE(steeringAngleOutOfRange_raw, CANSIG_FSM_noncriticalErrors_steeringAngleOutOfRange_SCALE, CANSIG_FSM_noncriticalErrors_steeringAngleOutOfRange_OFFSET, uint32_t);
    ...
    const uint32_t brakePressureOutOfRange_val = CAN_DECODE(brakePressureOutOfRange_raw, CANSIG_FSM_noncriticalErrors_brakePressureOutOfRange_SCALE, CANSIG_FSM_noncriticalErrors_brakePressureOutOfRange_OFFSET, uint32_t);
    ...
    const bool brakePressureSc_val = CAN_DECODE(brakePressureSc_raw, CANSIG_FSM_noncriticalErrors_brakePressureSc_SCALE, CANSIG_FSM_noncriticalErrors_brakePressureSc_OFFSET, uint32_t);
    ...
    const bool brakePressureOc_val = CAN_DECODE(brakePressureOc_raw, CANSIG_FSM_noncriticalErrors_brakePressureOc_SCALE, CANSIG_FSM_noncriticalErrors_brakePressureOc_OFFSET, uint32_t);
    ...
    const bool steeringWheelBroke_val = CAN_DECODE(steeringWheelBroke_raw, CANSIG_FSM_noncriticalErrors_steeringWheelBroke_SCALE, CANSIG_FSM_noncriticalErrors_steeringWheelBroke_OFFSET, uint32_t);
