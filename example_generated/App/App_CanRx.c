...
{
    rx_table.FSM_APPS_signals.Papps_Mapped_Pedal_Percentage_value = App_CanMsgs_FSM_APPS_Papps_Mapped_Pedal_Percentage_Clamp(value);
}

void App_CanRx_FSM_APPS_Sapps_Mapped_Pedal_Percentage_UpdateValue(float value) 
{
    rx_table.FSM_APPS_signals.Sapps_Mapped_Pedal_Percentage_value = App_CanMsgs_FSM_APPS_Sapps_Mapped_Pedal_Percentage_Clamp(value);
}
...
{
    rx_table.FSM_NON_CRITICAL_ERRORS_signals.LEFT_WHEEL_SPEED_OUT_OF_RANGE_value = App_CanMsgs_FSM_NON_CRITICAL_ERRORS_LEFT_WHEEL_SPEED_OUT_OF_RANGE_Clamp(value);
}

void App_CanRx_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_UpdateValue(uint32_t value) 
{
    rx_table.FSM_NON_CRITICAL_ERRORS_signals.RIGHT_WHEEL_SPEED_OUT_OF_RANGE_value = App_CanMsgs_FSM_NON_CRITICAL_ERRORS_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_Clamp(value);
}

void App_CanRx_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_UpdateValue(uint32_t value) 
{
    rx_table.FSM_NON_CRITICAL_ERRORS_signals.FLOW_RATE_OUT_OF_RANGE_value = App_CanMsgs_FSM_NON_CRITICAL_ERRORS_FLOW_RATE_OUT_OF_RANGE_Clamp(value);
}

void App_CanRx_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_UpdateValue(uint32_t value) 
{
    rx_table.FSM_NON_CRITICAL_ERRORS_signals.STEERING_ANGLE_OUT_OF_RANGE_value = App_CanMsgs_FSM_NON_CRITICAL_ERRORS_STEERING_ANGLE_OUT_OF_RANGE_Clamp(value);
}

void App_CanRx_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OUT_OF_RANGE_UpdateValue(uint32_t value) 
{
    rx_table.FSM_NON_CRITICAL_ERRORS_signals.BRAKE_PRESSURE_OUT_OF_RANGE_value = App_CanMsgs_FSM_NON_CRITICAL_ERRORS_BRAKE_PRESSURE_OUT_OF_RANGE_Clamp(value);
}
